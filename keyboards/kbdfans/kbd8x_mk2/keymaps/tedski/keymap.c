...
/* Shorten names to keep 7-character key grid */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT( /* Base layer */
	KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,        KC_F5,   KC_F6,   KC_MRWD, KC_MPLY,     KC_MFFD, KC_MUT,  KC_VDN,  KC_VUP,           KC_POWR, KC_SLCK, KC_PAUS, \
  ...
  [_FL] = LAYOUT( /* Function layer */
    _______,          _______, _______, _______, _______,      _______, _______, KC_F7,   KC_F8,       KC_F9,   KC_F10,  KC_F11,  KC_F12,          KC_PSCR, _______, _______, \
